...
function changeInfo(direction) {
  let currentInfoEl = cardInfosContainerEl.querySelector('.informacoes__corrente');
  let previousInfoEl = cardInfosContainerEl.querySelector('.informacoes__anterior');
  ...
  gsap
    ...
    .call(() => initCardEvents())
    .fromTo(
      direction === 'right' ? nextInfoEl.querySelectorAll('.texto') : previousInfoEl.querySelectorAll('.texto'),
      {
        opacity: 0,
        translateY: '40px',
      },
...
function updateCard(e) {
  ...
  const currentInfoEl = cardInfosContainerEl.querySelector('.informacoes__corrente');
...
function init() {
  ...
  tl.to(cardsContainerEl.children, {
    ...
    .to(cardInfosContainerEl.querySelector('.informacoes__corrente').querySelectorAll('.texto'), {
      delay: 0.5,
      duration: 0.4,
      stagger: 0.1,
      opacity: 1,
...
const waitForImages = () => {
  ...
  gsap.set(cardInfosContainerEl.querySelector('.informacoes__corrente').querySelectorAll('.texto'), {
    translateY: '40px',
    opacity: 0,
  });
